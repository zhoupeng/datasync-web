...
function no_hosts()
{
    ...
    echo "  <p class=\"action\">No suitable hosts for migrating $htvmname</p>\n";
}
...
function main()
{
    global $stage, $hosts, $migrated, $onload;
...
EOF;
    ...
    echo <<<EOF
<body onload="window.parent.actionCallback('$jsvmname', 'migrate', '$migrated');">
