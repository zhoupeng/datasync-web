...
function no_hosts()
{
    ...
    echo "<p class=\"action\">No suitable hosts on which to resume $htvmname</p>";
}
...
function main()
{
    global $stage, $hosts, $resumed, $onload;
...
EOF;
    ...
    echo <<<EOF
<body onload="window.parent.actionCallback('$jsvmname', 'resume', '$resumed');">
